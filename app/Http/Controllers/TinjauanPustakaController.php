...
class TinjauanPustakaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('mahasiswa.tinjauan_pustaka.create', compact('sesi', 'ruang'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(TinjauanPustaka $tinjauanPustaka)
    {
        //
    }
    ...
    public function berita(Request $request)
    {
        ...
        $path = public_path("/skripsi1/tinjauan_pustaka/BA/BA Tinjauan Pustaka.pdf");
       ...
       // let's bring another below it
        ...
        return $pdf->Output('D', 'Berita Acara Ujian Tinjauan Pustaka_'.$nama.''.'.pdf', true);
    }
}
