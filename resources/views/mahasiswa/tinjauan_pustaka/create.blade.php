@extends('layouts.app')
@section('title', 'Create Ujian Tinjauan Pustaka')
@section('content')
<div class="section">
    ...
    <div class="card">
        <div class="card-body table-responsive">
            ...
            @endif
        <form action="{{ route('tinjauan-pustaka.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <br>
                <input type="hidden" name="sidang_type" value="tinjauan_pustaka">
