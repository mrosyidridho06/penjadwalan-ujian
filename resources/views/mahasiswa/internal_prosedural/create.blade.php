@extends('layouts.app')
@section('title', 'Create Sidang Internal Prosedural')
@section('content')
<div class="section">
    <div class="section-header">
        <h1>Ajukan Jadwal Sidang Internal Prosedural</h1>
    </div>
    <div class="card">
        <div class="card-body table-responsive">
            ...
            @endif
        <form action="{{ route('internal-prosedural.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
