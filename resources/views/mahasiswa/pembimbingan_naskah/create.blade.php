@extends('layouts.app')
@section('title', 'Create Sidang Pembimbingan Naskah')
@section('content')
<div class="section">
    <div class="section-header">
        <h1>Ajukan Jadwal Sidang Pembimbingan Naskah</h1>
    </div>
    <div class="card">
        <div class="card-body table-responsive">
            ...
            @endif
        <form action="{{ route('pembimbingan-naskah.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <br>
                <input type="hidden" name="sidang_type" value="naskah_proposal">
