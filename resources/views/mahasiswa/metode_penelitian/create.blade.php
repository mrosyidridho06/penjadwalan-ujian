@extends('layouts.app')
@section('title', 'Create Ujian Metode Penelitian')
@section('content')
<div class="section">
    <div class="section-header">
        <h1>Ajukan Jadwal Sidang Metode Penelitian</h1>
    </div>
    <div class="card">
        <div class="card-body table-responsive">
            ...
            @endif
        <form action="{{ route('metode-penelitian.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
