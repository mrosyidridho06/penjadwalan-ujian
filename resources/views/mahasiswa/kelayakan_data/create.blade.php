@extends('layouts.app')
@section('title', 'Create Sidang Kelayakan Data')
@section('content')
<div class="section">
    <div class="section-header">
        <h1>Ajukan Jadwal Sidang Kelayakan Data</h1>
    </div>
    <div class="card">
        <div class="card-body table-responsive">
            ...
            @endif
        <form action="{{ route('kelayakan-data.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <br>
                <input type="hidden" name="sidang_type" value="kelayakan_data">
